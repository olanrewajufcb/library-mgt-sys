...
@Test
void addBook() {
    Book book1 = new Book("b22", "The Renaisance", "James Wallace", "1985");
    Library library = new Library();
    ...
    void borrowBook() {
        ...
        Book book1 = new Book("b22", "The rich also cry", "Wole Soyinka", "1985");
        ...
        assertEquals(Tope, library.borrowBook(book1));
    ...
    void totalBooksTaken() {
        ...
        Book book = new Book("a01", "The Renaisance", "James Wallace", "1985");
    ...
    void selectFromQueue() {
        ...
        library.makeRequest(emmanuel);
        library.makeRequest(jeniffer);
        assertEquals(ome, library.borrowBook(book));
    }
}